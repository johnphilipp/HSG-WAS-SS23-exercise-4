 ...
 */
export declare class ActorExtractLinksAll extends ActorExtractLinks {
    constructor(args: IActorArgs<IActionExtractLinks, IActorTest, IActorExtractLinksOutput>);
