...
class ActorRdfJoinEntriesSortTraversalZeroKnowledge extends bus_rdf_join_entries_sort_1.ActorRdfJoinEntriesSort {
    ...
    async run(action) {
        ...
        const sources = [];
        const dataSources = action.context.get(context_entries_1.KeysRdfResolveQuadPattern.sources);
        if (dataSources) {
            for (const source of dataSources) {
                const sourceValue = (0, bus_rdf_resolve_quad_pattern_1.getDataSourceValue)(source);
